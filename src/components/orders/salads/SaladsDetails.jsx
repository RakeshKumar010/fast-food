            ...
            <div className="flex justify-between lg:gap-7 gap-1 ">
                <fieldset className="border-2 px-3 w-1/2 border-black rounded-md">
                  ...
                  <select
                    ...
                    id="cars"
                  >
                    <option value="saab">REG ($6.99)</option>
                    <option value="opel">LRG ($11.99)</option>
                  </select>
                </fieldset>
                <fieldset className="border-2 px-3 w-1/2 border-black rounded-md">
                  <legend>Crust</legend>
                  <select
                    ...
                    id="cars"
                  >
                    <option value="volvo">GARLIC TOAST (L-2PCS)</option>
                    <option value="saab">GARLIC TOAST (R-1PC)</option>
